...
export default function PricingPage() {
  ...
  return (
    <div style={{ minHeight:'100vh', background:'#080613', color:'#fff', fontFamily:'system-ui,-apple-system,sans-serif' }}>
      ...
      {/* ── Mobile comparison — simple pill list ─────────────────────────── */}
      {isMobile && (
