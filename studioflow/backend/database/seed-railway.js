...
async function setup() {
  ...
  await conn.query(`
    ...
    CREATE TABLE IF NOT EXISTS schools (id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, name VARCHAR(180) NOT NULL, owner_name VARCHAR(120) NOT NULL, email VARCHAR(180) NULL, phone VARCHAR(40) NULL, city VARCHAR(80) NULL, address TEXT NULL, dance_style VARCHAR(80) NULL, is_active TINYINT(1) NOT NULL DEFAULT 1, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
    CREATE TABLE IF NOT EXISTS users (id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, name VARCHAR(120) NOT NULL, email VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, role ENUM('superadmin','school_admin','teacher','parent') NOT NULL DEFAULT 'parent', school_id INT UNSIGNED NULL, is_active TINYINT(1) NOT NULL DEFAULT 1, last_login DATETIME NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, UNIQUE KEY uq_email (email), FOREIGN KEY (school_id) REFERENCES schools(id) ON DELETE SET NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
    CREATE TABLE IF NOT EXISTS students (id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, school_id INT UNSIGNED NOT NULL, name VARCHAR(120) NOT NULL, age TINYINT UNSIGNED NULL, phone VARCHAR(40) NULL, email VARCHAR(180) NULL, guardian_name VARCHAR(120) NULL, guardian_phone VARCHAR(40) NULL, guardian_email VARCHAR(180) NULL, join_date DATE NULL, is_active TINYINT(1) NOT NULL DEFAULT 1, notes TEXT NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (school_id) REFERENCES schools(id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
    CREATE TABLE IF NOT EXISTS batches (id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, school_id INT UNSIGNED NOT NULL, name VARCHAR(120) NOT NULL, dance_style VARCHAR(80) NULL, level ENUM('Beginner','Intermediate','Advanced','Mixed') NOT NULL DEFAULT 'Beginner', teacher_id INT UNSIGNED NULL, teacher_name VARCHAR(120) NULL, max_size TINYINT UNSIGNED NULL, notes TEXT NULL, is_active TINYINT(1) NOT NULL DEFAULT 1, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (school_id) REFERENCES schools(id) ON DELETE CASCADE, FOREIGN KEY (teacher_id) REFERENCES users(id) ON DELETE SET NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
    CREATE TABLE IF NOT EXISTS batch_students (id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, batch_id INT UNSIGNED NOT NULL, student_id INT UNSIGNED NOT NULL, enrolled_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, UNIQUE KEY uq_batch_student (batch_id, student_id), FOREIGN KEY (batch_id) REFERENCES batches(id) ON DELETE CASCADE, FOREIGN KEY (student_id) REFERENCES students(id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
    CREATE TABLE IF NOT EXISTS schedules (id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, school_id INT UNSIGNED NOT NULL, batch_id INT UNSIGNED NOT NULL, day_of_week ENUM('Mon','Tue','Wed','Thu','Fri','Sat','Sun') NOT NULL, start_time TIME NOT NULL, end_time TIME NOT NULL, room VARCHAR(80) NULL, frequency ENUM('Weekly','Bi-weekly','Monthly') NOT NULL DEFAULT 'Weekly', notes TEXT NULL, is_active TINYINT(1) NOT NULL DEFAULT 1, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (school_id) REFERENCES schools(id) ON DELETE CASCADE, FOREIGN KEY (batch_id) REFERENCES batches(id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
    CREATE TABLE IF NOT EXISTS recitals (id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, school_id INT UNSIGNED NOT NULL, title VARCHAR(180) NOT NULL, event_date DATE NOT NULL, venue VARCHAR(180) NULL, status ENUM('Planning','Confirmed','Rehearsals','Completed','Cancelled') NOT NULL DEFAULT 'Planning', description TEXT NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, FOREIGN KEY (school_id) REFERENCES schools(id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
    CREATE TABLE IF NOT EXISTS recital_tasks (id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, recital_id INT UNSIGNED NOT NULL, task_text VARCHAR(255) NOT NULL, is_done TINYINT(1) NOT NULL DEFAULT 0, sort_order SMALLINT NOT NULL DEFAULT 0, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (recital_id) REFERENCES recitals(id) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
    ...
    CREATE TABLE IF NOT EXISTS student_fees (id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, school_id INT UNSIGNED NOT NULL, student_id INT UNSIGNED NOT NULL, fee_plan_id INT UNSIGNED NULL, description VARCHAR(180) NULL, amount DECIMAL(10,2) NOT NULL, currency VARCHAR(5) NOT NULL DEFAULT 'USD', due_date DATE NOT NULL, paid_date DATE NULL, status ENUM('Pending','Paid','Overdue','Waived') NOT NULL DEFAULT 'Pending', notes TEXT NULL, created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, FOREIGN KEY (school_id) REFERENCES schools(id) ON DELETE CASCADE, FOREIGN KEY (student_id) REFERENCES students(id) ON DELETE CASCADE, FOREIGN KEY (fee_plan_id) REFERENCES fee_plans(id) ON DELETE SET NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
  ...
  await conn.query(`INSERT INTO recital_tasks (recital_id,task_text,is_done,sort_order) VALUES
    ...
    (1,'Arrange stage lighting with venue',0,5),(1,'Print programs & tickets',0,6),(1,'Final dress rehearsal',0,7),
    (2,'Confirm date with all families',0,1),(2,'Select repertoire pieces',0,2),
    (3,'Register team for competition',1,1),(3,'Choreograph competition set',1,2),
    (3,'Book team travel & accommodation',0,3),(3,'Order matching team outfits',0,4),
    (3,'Submit music tracks to organizers',0,5),(3,'Run mock battle sessions x3',0,6),
    (4,'Set outdoor stage layout',0,1),(4,'Reach out to local food vendors',0,2),(4,'Design event flyer',0,3)`);
  ...
  const m = (offset) => { const d = new Date(today.getFullYear(), today.getMonth()+offset, 1); return d.toISOString().split('T')[0]; };
  ...
  console.log('Parent links seeded');
