...
export default function ParentPortalPage() {
  ...
  const { data: recitalsData } = useQuery<any>({ queryKey: ['parent-recitals'], queryFn: api.recitals });
  const children: any[] = childrenData || [];
  const recitals: any[] = recitalsData || [];
  const upcoming = recitals.filter((r: any) => new Date(r.event_date) >= new Date());
