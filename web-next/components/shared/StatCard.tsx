...
export default function StatCard({ label, value, icon, color, sub }: any) {
  return (
    <Card style={{ display: 'flex', alignItems: 'center', gap: 14, padding: 18 }}>
      <div style={{ width: 44, height: 44, borderRadius: 12, background: (color || '#7C3AED') + '22', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20, flexShrink: 0 }}>{icon}</div>
      <div>
