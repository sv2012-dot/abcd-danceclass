  ...
  <svg width="120" height="120" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {[66, 74, 82, 90].map((y, i) => (
      <g key={i}>
        ...
        <rect x="74" y={y - 2} width={i === 0 ? 22 : i === 1 ? 16 : 20} height="4" rx="2" fill="rgba(220,78,255,0.35)" />
      </g>
    ))}
    <defs>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: 10, width: '100%' }}>
          ...
          <button
            ...
            onMouseEnter={(e) => { (e.currentTarget as HTMLElement).style.transform = 'translateY(-1px)'; (e.currentTarget as HTMLElement).style.boxShadow = '0 6px 28px rgba(124,58,237,0.58)'; }}
